      ...
      data: [
        //----------增加以下代码----------
        {
          ...
          children: [
            {
              path: "order",
              component: "order/order/index", // 在views目录下创建对应文件 order/order/index.vue
              name: "Order",
              meta: {
                title: "订单管理",
            ...
            {
              path: "track",
              component: "order/track/index", // 在views目录下创建对应文件 order/track/index.vue
              name: "Track",
              meta: {
                title: "订单跟踪",
                icon: "el-icon-PhoneFilled",
                hidden: false,
                keepAlive: true,
                alwaysShow: false,
                params: null,
